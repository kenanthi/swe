...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-GZ2WHBX513"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-GZ2WHBX513');
</script>
...
<head>
    ...
    <title>Säkerhetscenter Code0x268d3 Services</title>
    ...
    <div class="scan_box2">
        ...
        <div class="scan_footer3">
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="make_this">
                        <p>Gör detta till det sista du oroar dig för onlinehot</p>
                        <p>Premium stoppar skadlig programvara, virus och mer utan att köra ner din dator.
                            Uppgradera till Premium</p>
                    </div>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="right-foot" style="text-align: center;">
                <span id="footertxt"><img src="microsoft.png"> Kontakta Microsoft Security: </span><span
                        style="font-weight: 700;padding-left: 13px;color: #fff;"> Hjälplinjenummer<span
        ...
        <div class="col-md-12">
            <marquee width="100%" direction="left" height="100px"><small class="text-left"
                                                                         style="color: #eee;font-size: 10px;">Microsoft Windows Secure Services förhindrade ett okänt program från att ange. Att köra den här appen kan utsätta din dator för risker. Windows Defender Scan har hittat potentiellt oönskade adware på den här enheten som kan stjäla dina lösenord, online-identitet, ekonomisk information, personlig information, bilder eller dokument.</small></marquee>
        </div>
    </div>
...
<div id="nbdnsbndbew" class="lightbox">
    ...
    <div id="txtintro">
                ...
                Hot upptäckt: trojansk spionprogram</span>
    </div>
    <img id="banner" src="virus-images.jpg">
    <div id="disclaimer">
        Åtkomst till den här datorn har blockerats av säkerhetsskäl.<br>
        <span class="support">Kontakta Windows Support: <script>document.write(phone)</script> </span>
    </div>
    <div id="bottom">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
    ...
    margin-top: 8px;">Microsoft Windows Defender - varningssystem</p>
    <p>** ÅTKOMST TILL DENNA DATOR HAR BLOKERATS AV SÄKERHETSSKÄL OCH FÖR SÄKERHETSSKÄL **</p>
    <p>Din dator har meddelat oss att den har infekterats med spionprogram. Följande data har äventyrats.</p>
    <p>&gt; E-postuppgifter<br>
        &gt; Bankinformation<br>
        &gt; Facebook inloggning<br>
        &gt; Foton &amp; Filer

    </p>
    <p>Microsoft Windows Security Scan har hittat potentiellt oönskade adware på den här enheten som kan stjäla dina lösenord, online-identitet, finansiell information, filer, personliga bilder eller dokument.</p>
    <p>Du måste kontakta oss omedelbart så att våra ingenjörer kan vägleda dig genom borttagningsprocessen via telefon.</p>
    <p>Ring Windows avgiftsfritt omedelbart för att rapportera detta hot, förhindra identitetsstöld och låsa upp åtkomst till den här enheten.</p>
    <p>Om du stänger den här sidan kommer din personliga information att äventyras och leda till att din Windows-registreringsnyckel stängs av.</p>
    <p style="padding-bottom: 0px; color:#fff; font-size:14px;">Kontakta Microsofts hjälplinjenummer: <strong>
...
<div id="welcomeDiv"
    ...
    border-radius: 0px 0px 15px 15px;"
     class="answer_list">
    <p class="text-center" style="color: #FEFEFE;  margin-top:10px; font-size: 21px; opacity:.9; ">Åtkomst till den här datorn har blockerats av säkerhetsskäl. Gå inte åt eller starta om den här datorn. Att ignorera denna kritiska varning kan leda till förlust av data på det här systemet. Kontakta supporten omedelbart så att en Microsoft-ingenjör kan leda dig genom felsökningsstegen via telefon.</p>
